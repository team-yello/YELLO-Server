...
public class ConstantUtil {
    ...
    public static final double THIRD_POINT_WEIGHT = 0.18;
    public static final double FOURTH_POINT_WEIGHT = 0.14;
    public static final double FIFTH_POINT_WEIGHT = 0.1;
    public static final double SIXTH_POINT_WEIGHT = 0.08;
    public static final double SEVENTH_POINT_WEIGHT = 0.06;

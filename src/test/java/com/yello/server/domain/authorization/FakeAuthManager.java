...
public class FakeAuthManager implements AuthManager {
    ...
    public FakeAuthManager(FriendRepository friendRepository, CooldownRepository cooldownRepository,
        UserRepository userRepository, TokenRepository tokenRepository, TokenProvider tokenProvider) {
